$(function() {
  ...
  $(document).ready(function () {
    var
      ...
      menuOptions = $('.menu'),
      menuBuffer = $('.menu:first-child').height() + parseInt($('.content .pagesection').css('margin-top')),
    ...
    projects.click(function (e) {
      ...
      if ($(this).hasClass('collapsed'))
        $(this).children('.content-container').slideUp();
      else
        $(this).children('.content-container').slideDown();
