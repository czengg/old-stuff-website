<?php
	...
	function the_vagaband_infinite_scroll_init() {
	    add_theme_support( 'infinite-scroll', array(
           'container' => 'content',
    	   ) );
	}	
	add_action( 'after_setup_theme', 'the_vagaband_infinite_scroll_init' );
	...
	function custom_comments($comment, $args, $depth) {
	  ...
	  ?>
	    <li id="comment-<?php comment_ID() ?>" <?php comment_class() ?>>
	        ...
	        <div class="comment-meta"><?php printf(__('%1$s at %2$s <span class="meta-sep">|</span> <a href="%3$s" title="Permalink to this comment">Permalink</a>', 'hbd-theme'),
	                    get_comment_date(),
	                    get_comment_time(),
