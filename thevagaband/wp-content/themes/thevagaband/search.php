...
<div id="custom-side-nav">
	<?php /* Side navigation */ ?>
	<ul id="custom-side-nav-list">
		<a href="http://cindyzeng.com/thevagaband"><li>
			<img src="http://cindyzeng.com/images/vagaband.png" id="vagaband-logo">
		</li></a>
		<a href="http://cindyzeng.com/thevagaband"><li class="nav-link">
			home
		</li></a>
		<a href="http://cindyzeng.com/thevagaband/?cat=2"><li class="nav-link">
			travel
		</li></a>
		<a href="http://cindyzeng.com/thevagaband/?cat=3"><li class="nav-link">
			food
		</li></a>
		<a href="http://cindyzeng.com/thevagaband/?cat=4"><li class="nav-link">
			musing
		</li></a>
		<a><li class="nav-link">
			about
